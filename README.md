...
The following env variables are supported:
 ...
 __Also:__  BLACKLIST_CHATS and WHITELIST_CHATS may require you to disable privacy mode in BotFather to allow the bot to see the incoming group messages.
### Python dependencies
