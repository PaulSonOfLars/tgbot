...
PM_START_TEXT = """
Hi {}, my name is {}! I am a private modification of the group management bot Marie! Which can be found [here](https://web.telegram.org/#/im?p=%40BanhammerMarie_bot)! 
...
def add_channel(bot, update):
    if (update.effective_chat.type == "channel"):
        ...
        channel_name = dispatcher.bot.getChat(channel_id).title
        try:
