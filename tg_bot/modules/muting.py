...
def mute(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if not user_id:
        message.reply_text("Dovrai o darmi un nome utente per mutarlo o rispondere a qualcuno che deve essere mutato.")
        return ""
    ...
    if member:
        if is_user_admin(chat, user_id, member=member):
            message.reply_text("Ho paura di non poter impedire a un amministratore di parlare!")
...
def unmute(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if member:
        ...
        message.reply_text("Questo utente non è nella chat, unmutarlo non gli permetterà di parlare!!")
