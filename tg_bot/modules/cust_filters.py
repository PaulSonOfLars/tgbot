...
*Только администратор:*
 - /filter <ключевое слово> <ответное сообщение>: добавить фильтр в этот чат. Теперь бот будет отвечать на это сообщение всякий раз, \
когда упоминается 'ключевое слово'. Если вы ответите на стикер с ключевым словом, бот ответит этим стикером. ПРИМЕЧАНИЕ: все ключевые слова \
фильтра написаны строчными буквами. Если вы хотите, чтобы ваше ключевое слово было предложением, используйте кавычки. например: /filter "привет" Как дела?
 - /stop <ключевое слово>: остановить этот фильтр.
"""

__mod_name__ = "Filters (Фильтры)"
