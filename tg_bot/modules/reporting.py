...
__mod_name__ = "Reporting (Сообщения админам)"

__help__ = """
 - /report <причина>: ответить на сообщение, чтобы сообщить об этом администраторам (они получат его копию в PM и канал журнала).
...
*Только администратор:*
 - /reports <on/off>: изменить настройки отчета или просмотреть текущий статус.
   - Если сделать в pm, включит или отключит получение вами таких сообщений.
