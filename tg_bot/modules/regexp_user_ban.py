    ...
    if joined_names is not None:
        for name in joined_names:
            for regex in regexes:
                ...
                if is_banned:
                    update.effective_message.reply_text("User fitting " + regex + " banned in this channel")
            ...
            for regex in regexes_global:
                ...
                if is_banned:
                    update.effective_message.reply_text("User fitting " + regex + " banned globally channels")
                    chat.kick_member(name.id)
                    break
