...
Блокируйте новых участников чата, имя пользователя которых соответствует одному из добавленных шаблонов регулярных выражений.
...
__mod_name__ = "Regexp User Ban (блокировка пользователей по регулярному выражению)"
