...
*Только администратор:*
 - /import: ответь хранителю группы файлом содержащим комвнды для импорта данных. Помни, что файлы и фото нельзя импортировать \
из-за ограничение Telegram
 - /export: Не реализовано
"""
