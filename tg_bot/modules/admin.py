...
*Только администратор:*
 - /pin: молча закрепляет сообщение, на которое ответили - добавьте 'loud' или 'notify', чтобы уведомлять пользователей
 - /unpin: открепить закрепленное в данный момент сообщение
 - /invitelink: получает ссылку на сообщение в чате
"""
