...
__help__ = """
 - s/<текст1>/<текст2>(/<модификатор>): при ответе на сообщение будет выполнена операция замены и новый текст опубликован в новом сообщении. 'текст1' будет везде заменен на 'текст2'. \
...
__mod_name__ = "Sed/Regex Замена текста"
