...
FWD_HANDLER = MessageHandler(Filters.forwarded, del_fwd)
GAME_HANDLER = MessageHandler(Filters.game, del_game)
...
dispatcher.add_handler(FWD_HANDLER, PERM_GROUP)
dispatcher.add_handler(GAME_HANDLER, PERM_GROUP)
